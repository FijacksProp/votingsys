...
urlpatterns = [
    ...
    path('vote/success/<uuid:election_id>/', views.vote_success, name='vote_success'),
    path('vote/already-voted/<uuid:election_id>/', views.already_voted, name='already_voted'),
